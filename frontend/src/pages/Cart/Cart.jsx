    ...
    <>
      ...
      <div id="container">
        ...
        <aside>
          ...
          <a href="#" class="flex justify-center items-center my-3 px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white">Checkout</a>
        </aside>
      </div>
    </>
  );
